...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.getAttr = function (attribute, value) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.toggleAttr = function (attribute, value = "true") {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.animateOverTime = function (duration, callback, finnaly) {
  let timeStart;
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.more').fadeIn(1800);
